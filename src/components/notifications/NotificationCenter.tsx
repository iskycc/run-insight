    ...
    <div className="static sm:relative" ref={containerRef}>
      ...
      {open && (
        <section
          role="dialog"
          aria-label="通知中心"
          className="dropdown-surface absolute right-0 top-full z-50 mt-2 w-[calc(100vw-2.5rem)] overflow-hidden rounded-[18px] border border-border bg-surface-solid shadow-xl sm:w-[min(24rem,calc(100vw-1rem))]"
        >
          ...
          <div className="max-h-[min(26rem,calc(100dvh-12rem))] overflow-y-auto">
            {loading ? (
              <LoadingState compact label="正在加载通知…" className="justify-center px-4 py-10" />
